...
<div id="header" style="text-align: center;padding-left: 30px;padding-top: 40px; padding-bottom: 20px;line-height:1;">
  <div>
    <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="header__logo" id="logo"><img src="<?php print $logo; ?>" alt="LA LISTE" title="LA LISTE des 1000 meilleurs Restaurants au Monde" class="header__logo-image" /></a><br/>
